...
## Import
 ...
 terraform import azapi_resource.example //providers/Microsoft.Insights/diagnosticSettings/{resourceName}
 
 # It also supports specifying API version by using the resource id with api-version as a query parameter, e.g.
 terraform import azapi_resource.example //providers/Microsoft.Insights/diagnosticSettings/{resourceName}?api-version=2021-05-01-preview
 ```
