...
## Import
 ...
 terraform import azapi_resource.example //providers/Microsoft.CostManagement/scheduledActions/{resourceName}
 
 # It also supports specifying API version by using the resource id with api-version as a query parameter, e.g.
 terraform import azapi_resource.example //providers/Microsoft.CostManagement/scheduledActions/{resourceName}?api-version=2025-03-01
 ```
